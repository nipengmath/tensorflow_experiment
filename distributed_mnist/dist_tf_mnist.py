...
## 并行方式，dist: sync or async
tf.app.flags.DEFINE_string('dist', 'async', ' "sync" or "async" ')
...
def build_model(x, y_, n_workers, is_chief, dist):
